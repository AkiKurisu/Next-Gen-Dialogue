...
namespace NextGenDialogue.Graph.Editor
{
    public static class DialogueGraphViewExtension
    {
        ...
        public static List<T> CollectNodes<T>(this DialogueGraphView graphView) where T : NodeElement
        {
            return graphView.nodes.OfType<T>().ToList();
        }
                
        public static List<T> CollectViews<T>(this DialogueGraphView graphView) where T : IDialogueNodeView
        {
            return graphView.nodes.OfType<T>().ToList();
        }
