...
namespace Kurisu.NGDT
{
    public static class DialogueTreeExtension
    {
        ...
        public static TraverseIterator Traverse(this IDialogueTree dialogueTree, bool includeChildren = true)
        {
            return new TraverseIterator(dialogueTree.Root, includeChildren);
        }
