...
{
    [Ordered]
    public class PromptPresetResolver : INodeResolver
    {
        public IDialogueNode CreateNodeInstance(Type type)
        {
            return new PromptPresetNode();
        }
        public static bool IsAcceptable(Type behaviorType) => behaviorType == typeof(PromptPresetModule);
        private class PromptPresetNode : ModuleNode
        {
            ...
            {
                promptField = (GetFieldResolver("prompt") as SharedTObjectResolver<TextAsset>).EditorField;
