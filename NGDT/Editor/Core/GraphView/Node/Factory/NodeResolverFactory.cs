...
namespace Kurisu.NGDT.Editor
{
    ...
    {
        private static NodeResolverFactory _instance;
        public static NodeResolverFactory Instance => _instance ?? new NodeResolverFactory();
        ...
        public IDialogueNode Create(Type behaviorType, DialogueTreeView treeView)
        {
            ...
            {
                var attribute = resolverType.GetCustomAttribute<CustomNodeEditorAttribute>();
                if (attribute != null)
                {
