...
namespace Kurisu.NGDT.Editor
{
    public abstract class ContainerNodeView : StackNode, IDialogueNodeView, ILayoutNode
    {
        ...
        public void SetNodeInstance(NGDT.DialogueNode dialogueNode)
        {
        ...
        public void Commit(Stack<IDialogueNodeView> stack)
        {
            ...
            nodes.ForEach(x =>
            {
                ((NGDT.ContainerNode)NodeBehavior).AddChild(x.Compile());
                stack.Push(x);
            });
            ...
            bridges.ForEach(bridge => bridge.Commit((NGDT.ContainerNode)NodeBehavior, stack));
