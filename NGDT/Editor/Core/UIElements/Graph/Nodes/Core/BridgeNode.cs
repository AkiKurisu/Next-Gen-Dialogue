...
namespace Kurisu.NGDT.Editor
{
    ...
    internal abstract class ChildBridge : Node
    {
        ...
        internal void Commit(Container container, Stack<IDialogueNodeView> stack)
        {
            OnCommit(container, stack);
        }
        protected virtual void OnValidate(Stack<IDialogueNodeView> stack) { }

        protected virtual void OnCommit(Container container, Stack<IDialogueNodeView> stack)
        {
            if (Child.connected)
            {
    ...
    internal class PieceBridge : ChildBridge, ILayoutNode
    {
        ...
        protected sealed override void OnCommit(Container container, Stack<IDialogueNodeView> stack)
        {
            if (_useReference)
            {
