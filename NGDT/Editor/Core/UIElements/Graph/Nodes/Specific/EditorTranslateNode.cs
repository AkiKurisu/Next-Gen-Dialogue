...
namespace Kurisu.NGDT.Editor
{
    ...
    public class EditorTranslateNode : EditorModuleNode
    {
        private bool IsPending { get; set; }
        
        public EditorTranslateNode(Type type, CeresGraphView graphView): base(type, graphView)
        {
        ...
        private void OnAttach(AttachToPanelEvent evt)
        {
            ...
            Graph.ContextualMenuRegistry.Register<EditorTranslateNode>(new TranslateContextualMenuBuilder(this, CanTranslate));
        }

        private void OnDetach(DetachFromPanelEvent evt)
        {
            //Do not forget to unregister after detach
            Graph.ContextualMenuRegistry.UnRegister<EditorTranslateNode>();
        }
            ...
            base(
               ...
               evt =>
               {
                   ...
                   evt.menu.MenuItems().Add(new CeresDropdownMenuAction("Translate", a =>
                    {
                        editorTranslateNode.TranslateNodeAsync(target as IDialogueNodeView);
                    }, _ =>
                   {
