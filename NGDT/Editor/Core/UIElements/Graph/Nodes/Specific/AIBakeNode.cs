...
namespace Kurisu.NGDT.Editor
{
    ...
    public class AIBakeNode : EditorModuleNode
    {
        ...
        public AIBakeNode(Type type, CeresGraphView graphView): base(type, graphView)
        {
        ...
        private async void GenerateCurrentSelection()
        {
            ...
            await DialogueBaker.GenerateDialogue(Graph);
        ...
        private async void AutoGenerateFromSelection()
        {
            ...
            _autoGenerate.SetEnabled(false);
            SaveCurrentSelection();
            await DialogueBaker.AutoGenerateDialogue(Graph);
            _bakeDialogue.SetEnabled(true);
            _autoGenerate.SetEnabled(true);
        }
