...
namespace Kurisu.NGDT.Editor
{
    public class NodeConvertor
    {
        ...
        public (RootNode, List<IDialogueNode>) ConvertToNode(IDialogueContainer tree, DialogueTreeView treeView, Vector2 initPos)
        {
            ...
            while (stack.Count > 0)
            {
                ...
                IDialogueNode node = DialogueNodeFactory.Get().Create(edgePair.NodeBehavior.GetType(), treeView);
