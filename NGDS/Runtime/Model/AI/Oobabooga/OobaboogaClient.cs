...
{
    internal class OobaboogaClient
    {
        ...
        public OobaboogaClient(string baseUri, OobaboogaParams genParams)
        {
        ...
        public async Task<ModelOutput> Generate(string message, CancellationToken ct)
        {
            stringBuilder.Clear();
            ...
            var response = await _client.PostAsync($"{_baseUri}/api/v1/generate", payload, ct);
